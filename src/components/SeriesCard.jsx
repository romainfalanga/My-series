...
export default function SeriesCard({ series, onResetRewatch, onDelete }) {
  ...
  return (
    <div className="bg-bg-card rounded-xl border border-border p-5 hover:border-accent/50 transition-all group">
        ...
        <div className="mt-3">
          ...
          {series.lastWatchedDate && series.rewatchIntervalMonths && (
            <button
              ...
              className="mt-3 w-full py-2 px-4 bg-accent hover:bg-accent-hover text-white rounded-lg text-sm font-medium transition-colors"
            >
